...
ActiveRecord::Schema[7.0].define(version: 2022_11_04_064837) do
  ...
  create_table "starred_tasks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["task_id"], name: "index_starred_tasks_on_task_id"
    t.index ["user_id"], name: "index_starred_tasks_on_user_id"
  end
